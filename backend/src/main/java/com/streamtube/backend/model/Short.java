...
public class Short {
    ...
    public Short(@JsonProperty("short_id") UUID short_id, @JsonProperty("title") String title,
        ...
        this.short_id = (short_id == null) ? UUID.randomUUID() : short_id;
        this.title = title;
    ...
    public void setshort_id(UUID short_id) {
